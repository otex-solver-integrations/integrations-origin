...
class OSwapV1Model:
    ...
    def get_amount_out(self, sell_token, sell_amount):
        inToken = sell_token
    ...
    def get_amount_in(self, buy_token, buy_amount):
        outToken = buy_token
    ...
    def process_rpc_data(self, data):
        results = OSwapV1Helper.get_state_call(data)
